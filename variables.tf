...
variable "maas_endpoint_service_id_1" {
  type        = string
  sensitive   = true
  description = "Service ID of MaaS VPC Endpoint Service, provided by Huawei Cloud upon request"
}

variable "maas_endpoint_service_id_2" {
  type        = string
  sensitive   = true
  description = "Service ID of MaaS VPC Endpoint Service, provided by Huawei Cloud upon request"
}